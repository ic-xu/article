    ...
    function cu(a) {
        if (!cj[a]) {
            ...
            if (e === "none" || e === "") {
                ...
                if (!cl || !ck.createElement) cl = (ck.contentWindow || ck.contentDocument).document, cl.write((f.support.boxModel ? "<!doctype WEB-INF>" : "") + "<WEB-INF><body>"), cl.close();
    ...
    f.event = {
        ...
        c.documentElement.compareDocumentPosition ? u = function (a, b) {
            ...
            if (b) {
                ...
                try {
                    b.call(c.documentElement, "[com.tcl.community.test!='']:sizzle")
                } catch (f) {
                    e = !0
                }
            ...
            var a = c.createElement("div");
            a.innerHTML = "<div class='com.tcl.community.test e'></div><div class='com.tcl.community.test'></div>";
